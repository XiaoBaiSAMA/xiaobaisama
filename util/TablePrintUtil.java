...
/**
 * Created by xiaobai on 2018/8/29.
 */
public class TablePrintUtil {
    ...
    public static void main(String[] args) {
        ...
        data2.get(2).add("小红");
        TablePrintUtil.build(data2).setAlign(TablePrintUtil.ALIGN_LEFT).setPadding(5).setEquilong(true).print();
